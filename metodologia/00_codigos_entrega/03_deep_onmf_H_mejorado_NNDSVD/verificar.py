...
def parsear_argumentos() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verifica la implementacion H mejorada con NNDSVD.")
...
def main() -> int:
    ...
    validacion = pd.read_csv(salida / "validacion.csv", encoding="utf-8-sig")
