...
- Caracteristicas deep ONMF: `C:\Users\armga\OneDrive\Escritorio\TFG\Programacion objetivo\comparacion final\04_prueba_ajustada_codigo_y_resultados\resultados\mejores_rasgos_deep_onmf.csv`.
...
| Deep ONMF | 1000 | 5 | 5 | 0.2809 | 1.3783 | 0.2602 | 1.3756 |
...
Mejor silhouette en rasgos: CNN (0.3318). Mejor Davies-Bouldin en rasgos: Deep ONMF (1.3783). Mejor silhouette t-SNE: Deep ONMF (0.2602). Mejor Davies-Bouldin t-SNE: Deep ONMF (1.3756).
...
- Deep ONMF. Deep ONMF usa el perfil ajustado guardado en la carpeta de barrido. En la foto local las clases forman grupos mas compactos y alejados que en la prueba SBV base; ademas la tabla coloca a Deep ONMF por delante de CNN en las dos metricas t-SNE y en Davies-Bouldin de rasgos. silhouette rasgos=0.2809; DB rasgos=1.3783; silhouette t-SNE=0.2602; DB t-SNE=1.3756.
...
En esta ejecucion deep ONMF obtiene la mejor separacion t-SNE segun las dos metricas de apoyo: silhouette mayor y Davies-Bouldin menor.
...
4. Conclusion de esta ejecucion: En esta ejecucion deep ONMF obtiene la mejor separacion t-SNE segun las dos metricas de apoyo: silhouette mayor y Davies-Bouldin menor. Por eso los ajustes se guardan como pruebas reproducibles y no se fuerza una conclusion que la tabla no sostenga.
