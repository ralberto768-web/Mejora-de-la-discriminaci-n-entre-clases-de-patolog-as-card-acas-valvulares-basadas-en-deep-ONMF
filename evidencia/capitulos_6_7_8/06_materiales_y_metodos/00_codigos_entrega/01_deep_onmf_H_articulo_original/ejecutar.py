...
from tfg_deep_onmf.pipeline import ejecutar_articulo_original


def parsear_argumentos() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Deep-ONMF H fiel al articulo: descarta audios menores de 2 s.")
...
def resolver_datos(ruta: Path | None) -> Path:
    ...
    candidatos = [Path.cwd(), CARPETA, *CARPETA.parents]
...
def main() -> int:
    ...
    if args.rapido or args.limite_por_clase > 0:
        ...
        carpeta = ejecutar_articulo_original(config)
